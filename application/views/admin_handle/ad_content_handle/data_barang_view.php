         ...
         <form action="" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
               <div class="container-fluid">
                  ...
                  <div class="form-group">
                     ...
                     <input type="file" name="foto-barang" class="form-control" id="" placeholder="Foto Barang">
                  </div>
                  <div class="form-group">
                     <label>Stok Barang</label>
                     <input type="number" name="stok-barang" class="form-control" id="" placeholder="Stok Barang">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="harga-beli" class="form-control" id="" placeholder="Harga Beli">
                  </div>
                  <div class="form-group">
                     <label>Harga Jual</label>
                     <input type="text" name="harga-jual" class="form-control" id="" placeholder="Harga Barang">
                  </div>
                  <div class="form-group">
